...
La Fig.~\ref{fig:mpc} muestra el comportamiento del MPC sobre el
sistema determinista. En (a) se observa la convergencia suave a la
referencia en $\sim$20~pasos. En (b), el plano de fase conecta el
inicio con la referencia. En (c), $a\to a_{\text{ref}}=0.30$,
$d\to d_{\text{ref}}=0.63$, $c\to0.0179$; sin violar cotas.
